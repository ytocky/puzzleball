...
class SourcePostFromStdin2Test extends \PHPUnit_Framework_TestCase
{
	...
	public function testNew()
	{
		...
		define('PUZZLEBALL_CLI_POST_MAX',18);
	...
	public function testNGValue($ball) {
		$this->assertNull($ball->ok_id3);
		$this->assertNull($ball->ok_id4);
	}
